...
pub fn book_name(book: i32) -> String {
    String::from(BOOK_NAMES[(book - 1) as usize])
}

pub fn num_verses_in_book(book: i32) -> i32 {
    let book = (book - 1) as usize;
    return NUM_VERSES_IN_BOOK[book];
}

pub fn num_chapters_in_book(book: i32) -> i32 {
    let book = (book - 1) as usize;
    return NUM_CHAPTERS_IN_BOOK[book];
}

pub fn num_verses_in_chapter(book: i32, chapter: i32) -> i32 {
    let book = (book - 1) as usize;
